import datetime
import os
from model import ML_BART, Token_Predictor, Sequence_Classifier
...
def main():
    ...
    model = Token_Predictor(hidden_dim = args.music_dim, class_num = args.music_dim).to(device)
    ...
    train_data, test_data = load_data(args.data_path, args.train_prop, args.max_len, args.gap, shuffle=True)
...
if __name__ == '__main__':
    ...
    # python pretrain_mlm.py --data_path /mnt/disk/dian/m2l_data/ --train_prop 0.9 --cuda_devices 0